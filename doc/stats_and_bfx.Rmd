...
"voom: Precision _weights_ unlock linear model analysis tools for RNA-seq read counts." Law et al (Genome Biol. 2014)

```{r, echo = TRUE}
with(
  dge_voom[row_carm1, ],
  lm.wfit(
    x = design, y = as.vector(E), w = as.vector(weights)
  )
