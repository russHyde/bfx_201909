...
Negative-Binomial $\mathcal{NB} \left( r, p \right)$
...
For a gene $g$ and sample $i$

$$y_i \sim \mathcal{NB}\left( mean = M_i p_j,\ dispersion = \phi \right)$$

where

- $y_i$ is the observed count

- $M_i$ is the library size

- $p_j$ is the relative abundance of $g$ in the experimental group $j$



Note, $\phi = 0$ is a Poisson model
